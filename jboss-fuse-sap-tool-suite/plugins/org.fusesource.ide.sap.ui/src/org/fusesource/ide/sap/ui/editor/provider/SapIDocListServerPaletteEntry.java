...
public class SapIDocListServerPaletteEntry implements
		ICustomPaletteEntry {
	...
	public static final String COMPONENT_URL = "sap-idoclist-server:<destination>:<idocType>:<idocTypeExtension>:<systemRelease>:<applicationRelease>"; //$NON-NLS-1$
