...
public class SapQueuedIDocListDestinationPaletteEntry implements
		ICustomPaletteEntry {
	
	public static final String COMPONENT_NAME = "SAP Queued IDoc List Destination"; //$NON-NLS-1$ 
	public static final String COMPONENT_DESCRIPTION = "Creates an SAP Queued IDoc List Destination endpoint..."; //$NON-NLS-1$
	public static final String COMPONENT_URL = "sap-qidoclist-destination:<destination>:<queue>:<idocType>:<idocTypeExtension>:<systemRelease>:<applicationRelease>"; //$NON-NLS-1$
