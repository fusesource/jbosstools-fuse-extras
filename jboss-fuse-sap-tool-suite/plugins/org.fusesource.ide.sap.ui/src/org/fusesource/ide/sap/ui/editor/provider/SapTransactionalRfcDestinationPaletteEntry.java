...
public class SapTransactionalRfcDestinationPaletteEntry implements
		ICustomPaletteEntry {
	...
	public static final String COMPONENT_URL = "sap-trfc-destination:<destination>:<rfc>"; //$NON-NLS-1$
