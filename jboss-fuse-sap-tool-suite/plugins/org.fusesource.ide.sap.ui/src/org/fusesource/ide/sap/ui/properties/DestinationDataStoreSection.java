...
public class DestinationDataStoreSection extends AbstractPropertySection {
	@Override
	public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
		...
		CLabel descriptionLabel = getWidgetFactory().createCLabel(descriptionContainer, Messages.DestinationDataStoreSection_DescriptionLabel, SWT.NONE);
