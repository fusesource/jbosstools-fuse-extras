...
public class SapQueuedRfcDestinationPaletteEntry implements
		ICustomPaletteEntry {
	...
	public static final String COMPONENT_URL = "sap-qrfc-destination:<destination>:<queue>:<rfc>"; //$NON-NLS-1$
