...
public class SapQueuedIDocDestinationPaletteEntry implements
	...
	public static final String COMPONENT_URL = "sap-qidoc-destination:<destination>:<queue>:<idocType>:<idocTypeExtension>:<systemRelease>:<applicationRelease>"; //$NON-NLS-1$
